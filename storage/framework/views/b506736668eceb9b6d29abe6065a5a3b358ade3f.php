...
<li class="gfield">
    <div class="ginput_container">
        ...
        <div class="col-md-9">
            <?php echo Form::text('ram',$post->get_meta('_ram'), array('placeholder'=>'RAM(GB)', 'id' => 'ram', 'class' => 'medium')); ?>
...
<li class="gfield">
    <div class="ginput_container">
        ...
        <div class="col-md-9">
            <?php echo Form::text('graphics_card',$post->get_meta('_graphics_card'), array('placeholder'=>'eg (NVDIA GeForce 640 M)','id' => 'ram', 'class' => 'medium')); ?>
...
<li class="gfield">
    <div class="ginput_container">
        ...
        <div class="col-md-9">
            <?php echo Form::text('harddisk',$post->get_meta('_harddisk'), array('placeholder'=>'Hard Disk(GB/TB)','id' => 'harddisk', 'class' => 'medium')); ?>
...
<li class="gfield">
    <div class="ginput_container">
        ...
        <div class="col-md-9">
            <?php echo Form::text('screen_size',$post->get_meta('_screen_size'), array('placeholder'=>'eg (15,17,13.5)','id' => 'screen_size', 'class' => 'medium')); ?>
