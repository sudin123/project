<li class="gfield">
    <div class="ginput_container">
        <div class="col-md-3">
            <?php echo Form::label('sim_slot', 'Sim SLot', array('class' => 'form-label')); ?>

        </div>
        <div class="col-md-9">
            <?php echo Form::select('sim_slot', [
                '' => 'Select Sim Slot',
          ...
          ], old('sim_slot'), ['class'=>'chosen-select']); ?>
...
<li class="gfield">
    <div class="ginput_container">
        <div class="col-md-3">
            <?php echo Form::label('camera', 'Camera', array('class' => 'form-label')); ?>

        </div>
        <div class="col-md-9">
            <?php echo Form::select('camera', [
                '' => 'Select Camera',
                'No'=>'No',
          ...
          ], old('camera'), ['class'=>'chosen-select']); ?>
...
<li class="gfield">
    <div class="ginput_container">
        <div class="col-md-3">
            <?php echo Form::label('smartphone_os', 'Smartphone OS', array('class' => 'form-label')); ?>

        </div>
        <div class="col-md-9">
            <?php echo Form::select('smartphone_os', [
                ...
                'Other OS'=>'Other OS',
          ], old('smartphone_os'), ['class'=>'chosen-select']); ?>
...
<li class="gfield">
    <div class="ginput_container">
        <div class="col-md-3">
            <?php echo Form::label('screen_size', 'Screen Size', array('class' => 'form-label')); ?>

        </div>
        <div class="col-md-9">
            <?php echo Form::select('screen_size', [
                ''=>'Select Screen Size',
          ...
          ], old('screen_size'), ['class'=>'chosen-select']); ?>
...
<li class="gfield">
    <div class="ginput_container">
        <div class="col-md-3">
            <?php echo Form::label('cpu_core', 'CPU Core', array('class' => 'form-label')); ?>

        </div>
        <div class="col-md-9">
            <?php echo Form::select('cpu_core', [
                ''=>'Select CPU Core',
                'Single'=>'Single',
                'Dual - 2'=>'Dual - 2',
                'Quad - 4'=>'Quad - 4',
                'Hexa - 6'=>'Hexa - 6',
                'Octa - 8'=>'Octa - 8',
          ], old('cpu_core'), ['class'=>'chosen-select']); ?>
...
<li class="gfield">
    <div class="ginput_container">
        <div class="col-md-3">
            <?php echo Form::label('ram', 'RAM', array('class' => 'form-label')); ?>

        </div>
        <div class="col-md-9">
            <?php echo Form::select('ram', [
                ''=>'Select RAM',
...
<li class="gfield">
    <div class="ginput_container">
        <div class="col-md-3">
            <?php echo Form::label('internal_storage', 'Internal Storage', array('class' => 'form-label')); ?>

        </div>
        <div class="col-md-9">
            <?php echo Form::select('internal_storage', [
          ...
          ], old('internal_storage'), ['class'=>'chosen-select']); ?>
...
<li class="gfield">
    <div class="ginput_container">
        <div class="col-md-3">
            <?php echo Form::label('features', 'Choose Features', array('class' => 'form-label')); ?>
