<?php $__env->startSection('title'); ?>Forget Password - sellnepal.com@parent <?php $__env->stopSection(); ?>
            ...
            <div class="col-xs-12 col-lg-6 col-lg-offset-3 col-xs-offset-0">
                <div class="access-block  login-block">
                    <div class="access-fields">
                        ...
                        <?php echo $__env->make('auth.forms.forgetform', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                    </div>
                </div>
            </div>
        </div>
