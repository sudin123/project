...
$PHPTHUMB_CONFIG['cache_directory'] = storage_path() . "/cache/";
...
$PHPTHUMB_CONFIG['disable_debug'] = !Config::get('app.debug'); // prevent phpThumb from displaying any information about your system. If true, phpThumbDebug and error messages will be disabled
