...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | The following language lines are the default lines which match email
    | titles, buttons, links, and messages.
    |
    */
    ...
    'emailRegistrationPwFooter'        	=> 	'&copy; 2016 sellnepal.com',
    ...
    'emailResetPwFooter'        		=> 	'&copy; 2016 sellnepal.com',
