@extends('site')
@section('title')Search Results - Sellnepal@parent @stop
@section('meta_robots')noindex@parent @stop
@section('googlebot')noindex@parent @stop
@section('styles')
            ...
            <div class="col-md-9 col-sm-9">
                ...
                <div class="content ">
                    <div class="sec-title clearfix">
                        <h2>Search Results for <span class="search-res">{{ $search }} </span></h2>
                    </div>
                    <div class="content-entry">
                        ...
                        {{ $posts->appends(array('q' => $search, 'city'=> $city, 'category'=>$category, 'pmin'=>$pmin, 'pmax'=>$pmax, 'condition'=> $condition))->links() }}
