@extends('site')
@section('title')Company Profiles - sellnepal.com@parent @stop
@section('meta_description')Dealers Profile - Sellnepal@parent @stop
@section('meta_keywords') dealers in nepal, vendors in nepal, buy sale nepal, classified ads nepal @parent @stop
                            ...
                            <li class="post clearfix">
                                ...
                                <div class="entry clearfix">
                                    <h4>
                                        ...
                                        <a class="dealers-post-count" href="{{ url('dealers/'.$user->username) }}">
