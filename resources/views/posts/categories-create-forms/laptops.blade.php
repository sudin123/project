...
<li class="gfield">
    <div class="ginput_container">
        ...
        <div class="col-md-9">
            {!! Form::text('graphics_card', old('graphics_card'), array('placeholder'=>'eg (NVDIA GeForce 640 M)','id' => 'ram', 'class' => 'medium')) !!}
        </div>
    </div>
</li>
...
<li class="gfield">
    <div class="ginput_container">
        ...
        <div class="col-md-9">
            {!! Form::text('screen_size', old('screen_size'), array('placeholder'=>'eg (15,17,13.5)','id' => 'screen_size', 'class' => 'medium')) !!}
        </div>
    </div>
</li>
<li class="gfield">
