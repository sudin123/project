...
<li class="gfield">
    <div class="ginput_container">
        ...
        <div class="col-md-9">
            {!! Form::text('property_location', old('property_location'), array('id' => 'location', 'class' => 'medium', 'placeholder' => 'eg.(Samakhusi, Near ALL Nepal Hospital)')) !!}
        </div>
    </div>
</li>
<li class="gfield">
...
<li class="gfield">
    <div class="ginput_container">
        ...
        <div class="col-md-9">
            {!! Form::text('land_size', old('land_size'), array('id' => 'landsize', 'class' => 'medium', 'placeholder' => 'Land Size')) !!}
        </div>
    </div>
</li>
<li class="gfield">
    <div class="ginput_container">
        ...
        <div class="col-md-9">
            {!! Form::text('bedrooms', old('bedrooms'), array('id' => 'bedrooms', 'class' => 'medium', 'placeholder' => 'eg: 5')) !!}
        </div>
    </div>
</li>
<li class="gfield">
    <div class="ginput_container">
        ...
        <div class="col-md-9">
            {!! Form::text('bathroom', old('bathroom'), array('id' => 'bathroom', 'class' => 'medium', 'placeholder' => 'eg: 2')) !!}
        </div>
    </div>
</li>
<li class="gfield">
    <div class="ginput_container">
        ...
        <div class="col-md-9">
            {!! Form::text('livingroom', old('livingroom'), array('id' => 'livingroom', 'class' => 'medium', 'placeholder' => 'eg: 1')) !!}
        </div>
    </div>
</li>
<li class="gfield">
