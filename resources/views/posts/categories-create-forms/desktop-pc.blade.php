...
<li class="gfield">
    <div class="ginput_container">
        ...
        <div class="col-md-9">
            {!! Form::text('ram', old('ram'), array('placeholder'=>'RAM(GB)', 'id' => 'ram', 'class' => 'medium')) !!}
        </div>
    </div>
</li>
...
<li class="gfield">
    <div class="ginput_container">
        ...
        <div class="col-md-9">
            {!! Form::text('graphics_card', old('graphics_card'), array('placeholder'=>'Graphics Card','id' => 'ram', 'class' => 'medium')) !!}
        </div>
    </div>
</li>
...
<li class="gfield">
    <div class="ginput_container">
        ...
        <div class="col-md-9">
            {!! Form::text('harddisk', old('harddisk'), array('placeholder'=>'Hard Disk(GB/TB)','id' => 'harddisk', 'class' => 'medium')) !!}
        </div>
    </div>
</li>
...
<li class="gfield">
    <div class="ginput_container">
        ...
        <div class="col-md-9">
            {!! Form::text('moniter_desc', old('moniter_desc'), array('placeholder'=>'eg (Samsung 21 inch LED, DELL 13inch LED)','id' => 'moniter_desc', 'class' => 'medium')) !!}
        </div>
    </div>
</li>
<li class="gfield">
